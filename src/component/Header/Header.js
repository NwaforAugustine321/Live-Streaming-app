...
const Header = () => {
  ...
  useEffect(() => {
    const checkIfClickedOutside = (e) => {
      ...
      // then close the menu
      if (showCatalog && ref.current && !ref.current.contains(e.target)) {
            ...
            <div className="header__content">
              ...
              <ul className="header__nav">
                ...
                <li className="header__nav-item">
                  ...
                  {showCatalog && (
                    <ul
                      className="dropdown-menu header__nav-menu show"
                      aria-labelledby="dropdownMenu1"
                    >
                      <li>
                        <a href="catalog.html">Catalog</a>
                      </li>
                      <li ref={ref} className="dropdown-submenu">
                        <a
                ...
                <li className="header__nav-item">
                  ...
                  >
                    ...
                    <li>
                      <a
                        href="https://dmitryvolkov.me/demo/flixtv/admin/index.html"
                        target="_blank"
                      >
                        Admin pages
                      </a>
