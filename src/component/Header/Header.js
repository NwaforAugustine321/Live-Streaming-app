...
const Header = () => {
	...
	const handleShowCatalog = (event) => {
		event.preventDefault();
		setShow(!show);

		document.querySelector('.dropdownMenu1').classList.add('show');
	...
	const handleShowProfile = (event) => {
		...
		document.querySelector('.dropdownMenu3').classList.add('show');

		if (!show) {
			document.querySelector('.dropdownMenu3').classList.remove('show');
		}
	};
						...
						<div className='header__content'>
							...
							<ul className='header__nav'>
								...
								<li className='header__nav-item'>
									...
									<ul id='dropdownMenu1' className='dropdown-menu header__nav-menu dropdownMenu1' aria-labelledby='dropdownMenu1'>
										<li>
										...
										<li>
											<a href='/category'>Category style 1</a>
										</li>

										<li>
											<a href='/detail'>Details style 1</a>
										</li>
									</ul>
								</li>
								<li className='header__nav-item'>
								...
								<li className='header__nav-item'>
									<a className='header__nav-link header__nav-link--live' href='/live'>
										LIVE
								...
								<li className='header__nav-item'>
									...
									<ul
										className='dropdown-menu header__nav-menu header__nav-menu--scroll dropdownMenu3'
