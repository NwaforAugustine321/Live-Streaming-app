					...
					<div className='row'>
						...
						<div className='col-12'>
							<p className='section__text section__text--small'>
								Many desktop publishing packages and <a href='#'>web page</a> editors now use Lorem Ipsum as their default model text,
							...
							<p className='section__text section__text--small'>
								All the Lorem Ipsum generators on the <b>Internet</b> tend to repeat predefined chunks as necessary, making this the
					...
					<div className='row row--grid'>
						...
						<div className='col-12 col-lg-4'>
							<div className='step'>
								...
								<h3 className='step__title'>Enjoy FlixTV</h3>
								<p className='step__text'>
									It to make a type specimen book. It has survived not only five centuries, but also the leap into electronic
									typesetting
								</p>
					...
					<div className='row row--grid'>
						...
						<div className='col-12 col-md-6 col-lg-4 col-xl-3'>
							<div className='feature'>
								...
								<h3 className='feature__title'>Choose your Plan</h3>
								<p className='feature__text'>
									t to make a type specimen book. It has survived not only five centuries, but also the leap into electronic
