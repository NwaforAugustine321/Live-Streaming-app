const Profile = () => {
					...
					<div className='col-12'>
						<div className='header__content'>
							...
							<div className='header__actions'>
								...
								<a href='profile.html' className='header__user'>
									<span>John Doe</span>
									<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'>
				...
				<div className='col-12'>
					<div className='profile'>
						...
						<ul className='nav nav-tabs profile__tabs' id='profile__tabs' role='tablist'>
							...
							<li className='nav-item'>
								<a className='nav-link' data-toggle='tab' href='#tab-3' role='tab' aria-controls='tab-3' aria-selected='false'>
									Settings
								</a>
							</li>
						</ul>
	...
	<form action='#' id='modal-topup' className='zoom-anim-dialog mfp-hide modal modal--form'>
