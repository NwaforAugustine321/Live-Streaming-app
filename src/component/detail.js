	...
	return (
		<div>
			...
			<section className='section section--head section--head-fixed section--gradient section--details-bg'>
				<div className='section__bg' data-bg='img/details.jpg' />
				<div className='container'>
					{/* article */}
					...
					<div className='row'>
						...
						<div className='col-12'>
							<div className='section__carousel-wrap'>
								...
								<button className='section__nav section__nav--cards section__nav--prev' data-nav='#similar' type='button'>
									<svg width={17} height={15} viewBox='0 0 17 15' fill='none' xmlns='http://www.w3.org/2000/svg'>
								...
								<button className='section__nav section__nav--cards section__nav--next' data-nav='#similar' type='button'>
									<svg width={17} height={15} viewBox='0 0 17 15' fill='none' xmlns='http://www.w3.org/2000/svg'>
