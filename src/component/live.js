							...
							<div className='col-12'>
								<div className='header__content'>
									...
									<ul className='header__nav'>
										...
										<li className='header__nav-item'>
											<a className='header__nav-link header__nav-link--live' href='live.html'>
												LIVE
										...
										<li className='header__nav-item'>
											...
											<ul className='dropdown-menu header__nav-menu header__nav-menu--scroll' aria-labelledby='dropdownMenu3'>
												...
												<li>
													<a href='https://dmitryvolkov.me/demo/flixtv/admin/index.html' target='_blank'>
														Admin pages
													</a>
												</li>
												<li>
						...
						<div className='row'>
							<div className='col-12'>
								<div className='section__carousel-wrap'>
									<div className='section__live owl-carousel' id='livetv'>
										<div className='live'>
											...
											<h3 className='live__title'>
												<a href='http://www.youtube.com/watch?v=0O2aH4XLbto' className='open-video'>
										...
										<div className='live'>
											...
											<h3 className='live__title'>
												<a href='http://www.youtube.com/watch?v=0O2aH4XLbto' className='open-video'>
													RERUN: Seither vs. RazerBlader - DH Masters: Winter 2020 - Playoffs - OCE
												</a>
											</h3>
										</div>
										<div className='live'>
									...
									<button className='section__nav section__nav--live section__nav--prev' data-nav='#livetv' type='button'>
									...
									<button className='section__nav section__nav--live section__nav--next' data-nav='#livetv' type='button'>
										<svg width={17} height={15} viewBox='0 0 17 15' fill='none' xmlns='http://www.w3.org/2000/svg'>
								...
								<div className='section__carousel-wrap'>
									<div className='section__live owl-carousel' id='recommended'>
										<div className='live'>
											...
											<h3 className='live__title'>
												<a href='http://www.youtube.com/watch?v=0O2aH4XLbto' className='open-video'>
													What Was Ben Affleck Planning for His Unmade 'Batman' Film?
												</a>
											</h3>
										</div>
										<div className='live'>
									...
									<button className='section__nav section__nav--live section__nav--prev' data-nav='#recommended' type='button'>
										<svg width={17} height={15} viewBox='0 0 17 15' fill='none' xmlns='http://www.w3.org/2000/svg'>
											<path d='M1.25 7.72559L16.25 7.72559' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
											<path
												d='M7.2998 1.70124L1.2498 7.72524L7.2998 13.7502'
									...
									<button className='section__nav section__nav--live section__nav--next' data-nav='#recommended' type='button'>
										<svg width={17} height={15} viewBox='0 0 17 15' fill='none' xmlns='http://www.w3.org/2000/svg'>
											<path d='M15.75 7.72559L0.75 7.72559' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
											<path
												d='M9.7002 1.70124L15.7502 7.72524L9.7002 13.7502'
						...
						<div className='row'>
							...
							<div className='col-12'>
								<div className='section__carousel-wrap'>
									...
									<button className='section__nav section__nav--live section__nav--prev' data-nav='#hype' type='button'>
										<svg width={17} height={15} viewBox='0 0 17 15' fill='none' xmlns='http://www.w3.org/2000/svg'>
											<path d='M1.25 7.72559L16.25 7.72559' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
											<path
												d='M7.2998 1.70124L1.2498 7.72524L7.2998 13.7502'
									...
									<button className='section__nav section__nav--live section__nav--next' data-nav='#hype' type='button'>
										<svg width={17} height={15} viewBox='0 0 17 15' fill='none' xmlns='http://www.w3.org/2000/svg'>
											<path d='M15.75 7.72559L0.75 7.72559' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
											<path
												d='M9.7002 1.70124L15.7502 7.72524L9.7002 13.7502'
