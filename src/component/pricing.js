					...
					<div className='container'>
						<div className='row'>
							<div className='col-12 col-xl-6'>
								<h1 className='section__title section__title--head'>Pricing plans</h1>
							</div>
							<div className='col-12 col-xl-6'>
								<ul className='breadcrumb'>
									...
									<li className='breadcrumb__item breadcrumb__item--active'>Pricing plans</li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div className='row'>
							...
							<div className='col-12'>
								<p className='section__text section__text--small'>
									Many desktop publishing packages and <a href='#'>web page</a> editors now use Lorem Ipsum as their default model
								...
								<p className='section__text section__text--small'>
									All the Lorem Ipsum generators on the <b>Internet</b> tend to repeat predefined chunks as necessary, making this
									...
									<div className='table-responsive'>
										<table className='plans__table'>
											...
											<tbody>
												<tr>
													<td>
														<span className='plans__title'>FlixTV Originals</span>
													</td>
													<td>
												...
												<tr>
													<td>
														<span className='plans__title'>Watch Live TV online and on supported devices</span>
													</td>
													<td>
														<span className='plans__status plans__status--green'>
															<svg
												...
												<tr>
													<td>
														<span className='plans__title'>Switch plans or cancel anytime</span>
													</td>
													<td>
														<span className='plans__status plans__status--green'>
															<svg
												...
												<tr>
													<td>
														<span className='plans__title'>Record live TV with 50 hours of Cloud DVR storage</span>
													</td>
													<td>
												...
												<tr>
													<td>
														<span className='plans__title'>Stream 65+ top Live</span>
													</td>
													<td>
														<span className='plans__status plans__status--red'>
															<svg
